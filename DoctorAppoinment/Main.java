...
public class Main {
    public static void main(String args[]){
        ...
        if(patient1.getDoctorType()=="General"){
            DoctorInterface gd = new GeneralDoctor(177,1000,patient1);
            patient1.setGd(gd);
            gd.bookAppoinment();

        }
        else{
            DoctorInterface sd = new SpecialistDoctor(178,2000,patient1);
            patient1.setSd(sd);
            sd.bookAppoinment();
        ...
        if(patient2.getDoctorType()=="General"){
            DoctorInterface gd = new GeneralDoctor(179,1000,patient2);
            patient2.setGd(gd);
            gd.bookAppoinment();
        }
        else{
            DoctorInterface sd = new SpecialistDoctor(180,2000,patient2);
            patient2.setSd(sd);
            sd.bookAppoinment();
